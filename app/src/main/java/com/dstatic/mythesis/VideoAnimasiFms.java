...
public class VideoAnimasiFms extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_animasi_fms);
        ...
        simpleExoPlayer = ExoPlayerFactory.newSimpleInstance(
                VideoAnimasiFms.this,trackSelector,loadControl
        );
